...
case class TIME_TO_PICK(str: String) extends WorkflowToken
case class VEHICLE(str: String) extends WorkflowToken
case class DURATION(str: String) extends WorkflowToken
case class DISTANCE(str: String) extends WorkflowToken
case class PAID(str: String) extends WorkflowToken
